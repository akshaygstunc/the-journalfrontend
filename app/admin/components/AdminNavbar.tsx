    ...
    <header className="h-17.5 bg-[#F5F5F5] flex items-center justify-between px-6 border-b border-[#E5E5E5]">
      ...
      <div className="relative">
        <button
          ...
          className="flex items-center gap-5 text-[#212121] hover:text-[#861212] transition-colors p-1 rounded-lg"
        >
          ...
          <div className="rounded-full"><IoIosArrowDown /></div>
        </button>
        ...
        {isDropdownOpen && (
          <div className="absolute right-0 top-full mt-2 w-48 bg-white border border-[#E5E5E5] rounded-lg shadow-lg py-2 z-50">
            ...
            <button   onClick={handleLogout} className="w-full flex items-center gap-3 px-4 py-2 text-sm text-[#212121] hover:bg-[#F5F5F5] rounded-lg transition-colors">
